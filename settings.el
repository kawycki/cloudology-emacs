(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (eshell-prompt-extras smartparens flycheck diredfl magit persistent-scratch eshell-toggle quelpa-use-package quelpa beginend projectile rg wgrep transient which-key compdef counsel swiper ivy-prescient command-log-mode try prescient ivy company page-break-lines no-littering restart-emacs doom-modeline all-the-icons memoize gcmh doom-themes use-package)))
